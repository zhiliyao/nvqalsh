...
int main(int nargs, char **args)
{
	...
	case 0:
		...
		break;
	case 2:
		qalsh(n, qn, d, p, zeta, ratio, k, (const float **) data, 
	...
	case 3:
		...
		break;
	case 5:
		qalsh_tree(n, qn, d, p, zeta, ratio, k, (const float **) data,
			data_set, "/home/pmem/test", (const float **) query, (const Result **) R, out_path);
		break;
	case 6:
		write_nvm_data(n, qn, d, (const float**)data, (const float**)query, 
		"/home/pmem/test");
		break;
	case 9:
		test_rebuild_tree(n, d, p, zeta, ratio, (const float**) data,
		data_set, "/home/pmem/test", out_path);
		break;
	default:
